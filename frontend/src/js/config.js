// Detecta si la app esta en local para ajustar automaticamente las URLs de la API y los archivos.
...
// URL base para cargar recursos estaticos alojados en el backend y servir recibos/avatares.
